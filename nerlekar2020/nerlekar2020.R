...
# two free datasets. The country and coastlines from Natural Earth.
...
world_map_panel = ggplot() + 
  ...
  geom_sf(data=point_data, aes(color=continent_label),size=3, fill=NA) +
